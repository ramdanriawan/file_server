...
@Entity
@Table(name="OJK_RULES_PK02")
@NamedQuery(name="OJKRulesPK02Entity.findAll", query="SELECT r FROM OJKRulesPK02Entity r")
public class OJKRulesPK02Entity extends OJKRulesEntity implements Serializable {
    @Id
    @Column(name = "ID_KEY")
    ...
    public static final String reportCode = "PK02";
    public OJKRulesPK02Entity() {
    }

    public OJKRulesPK02Entity(Long idKey, String sheetRow, String rowType, String kolomA, String kolomB, String kolomC,
    ...
    public String toString() {
        return "OJKRulesPK02Entity [idKey=" + idKey + ", sheetRow=" + sheetRow + ", rowType=" +
