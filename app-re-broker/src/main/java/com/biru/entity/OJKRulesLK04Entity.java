...
@Entity
@Table(name="OJK_RULES_LK04")
@NamedQuery(name="OJKRulesLK04Entity.findAll", query="SELECT r FROM OJKRulesLK04Entity r")
public class OJKRulesLK04Entity extends OJKRulesEntity implements Serializable {
    @Id
    @Column(name = "ID_KEY")
    ...
    public static final String reportCode = "LK04";

    public OJKRulesLK04Entity() {
    }

    public OJKRulesLK04Entity(Long idKey, String sheetRow, String rowType, String kolomA, String kolomB, String kolomC,
    ...
    public String toString() {
        return "OJKRulesLK04Entity [idKey=" + idKey + ", sheetRow=" + sheetRow + ", rowType=" +
