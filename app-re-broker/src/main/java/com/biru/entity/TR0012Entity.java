...
@Entity
@Table(name="TR0012")
@NamedQuery(name="TR0012Entity.findAll", query="SELECT t FROM TR0012Entity t")
public class TR0012Entity implements Serializable, Comparable<TR0012Entity> {
	...
	public TR0012Entity(Long idKey, String trxDateStr, String trxType, String trxVoucherId, String cliName, String trxDescription, 
	...
	public TR0012Entity(Long idKey, String trxType, String trxVoucherId, 
	...
	public TR0012Entity(Long idKey, Date createOn, Date trxDate, 
	...
	@Override
	public int compareTo(TR0012Entity tR0012Entity) {
