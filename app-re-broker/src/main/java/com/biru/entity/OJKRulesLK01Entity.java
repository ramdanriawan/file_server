...
@Entity
@Table(name="OJK_RULES_LK01")
@NamedQuery(name="OJKRulesLK01Entity.findAll", query="SELECT r FROM OJKRulesLK01Entity r")
public class OJKRulesLK01Entity extends OJKRulesEntity implements Serializable {
    @Id
    @Column(name = "ID_KEY")
    ...
    public static final String reportCode = "LK01";

    public OJKRulesLK01Entity() {
    }

    public OJKRulesLK01Entity(Long idKey, String sheetRow, String rowType, String kolomA, String kolomB, String kolomC,
    ...
    public String toString() {
        return "OJKRulesLK01Entity [idKey=" + idKey + ", sheetRow=" + sheetRow + ", rowType=" +
