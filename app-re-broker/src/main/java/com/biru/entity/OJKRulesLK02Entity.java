...
@Entity
@Table(name="OJK_RULES_LK02")
@NamedQuery(name="OJKRulesLK02Entity.findAll", query="SELECT r FROM OJKRulesLK02Entity r")
public class OJKRulesLK02Entity extends OJKRulesEntity implements Serializable {
    @Id
    @Column(name = "ID_KEY")
    ...
    public static final String reportCode = "LK02";

    public OJKRulesLK02Entity() {
    }

    public OJKRulesLK02Entity(Long idKey, String sheetRow, String rowType, String kolomA, String kolomB, String kolomC,
    ...
    public String toString() {
        return "OJKRulesLK02Entity [idKey=" + idKey + ", sheetRow=" + sheetRow + ", rowType=" +
