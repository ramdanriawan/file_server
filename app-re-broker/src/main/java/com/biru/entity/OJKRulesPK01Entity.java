...
@Entity
@Table(name="OJK_RULES_PK01")
@NamedQuery(name="OJKRulesPK01Entity.findAll", query="SELECT r FROM OJKRulesPK01Entity r")
public class OJKRulesPK01Entity extends OJKRulesEntity implements Serializable {
    @Id
    @Column(name = "ID_KEY")
    ...
    public static final String reportCode = "PK01";

    public OJKRulesPK01Entity() {
    }

    public OJKRulesPK01Entity(Long idKey, String sheetRow, String rowType, String kolomA, String kolomB, String kolomC,
    ...
    public String toString() {
        return "OJKRulesPK01Entity [idKey=" + idKey + ", sheetRow=" + sheetRow + ", rowType=" +
