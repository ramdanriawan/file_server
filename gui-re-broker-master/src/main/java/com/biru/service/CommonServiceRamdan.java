...
public interface CommonServiceRamdan {
	...
	public List<DropdownIdText> getVoucherId() throws ParseException, JsonParseException, JsonMappingException, IOException;
	...
	String tr0006InquiryVir(Map<String, Object> param) throws JsonProcessingException;
}