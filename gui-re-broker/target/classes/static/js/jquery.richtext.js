(function ( $ ) {
    ...
    $.fn.richText = function( options ) {
        ...
        var settings = $.extend({
            ...
            // text alignment
            leftAlign: true, centerAlign: true, rightAlign: true, justify: true,
        ...
        var $editor,
            ...
            $btnJustify = $('<a />', {class: "richText-btn fa fa-align-justify", "data-command": "justifyFull"}), 
        ...
        var editorID = "richText-" + settings.id;
