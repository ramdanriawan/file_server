...
public interface GuiConstants {
	...
	interface HTML {
		...
		// OJK Report Setup
		final String SD_OJK_REPORT_SETUP_DIRECT = "staticdata/ojkreportsetupdirect";
		...
		//Direct Production BDS
		final String M_DPRODUCTION_BDS		= "marketing/directProductionBDS";
	...
	interface REST {
		...
		// OJK REPORT SETUP DIRECT
		final String SD_OJK_REPORT_SETUP_DIRECT			= "/ojk-report-setup-direct";
		final String SD_OJK_REPORT_SETUP_DIRECT_INQUIRY = SD_OJK_REPORT_SETUP_DIRECT + "/inquiry";
		final String SD_OJK_REPORT_SETUP_DIRECT_DELETE = SD_OJK_REPORT_SETUP_DIRECT + "/delete";
		final String SD_OJK_REPORT_SETUP_DIRECT_SAVE = SD_OJK_REPORT_SETUP_DIRECT + "/save";
		final String SD_OJK_REPORT_SETUP_DIRECT_DROPDOWN_REPORT_CODE = SD_OJK_REPORT_SETUP_DIRECT + "/dropdown-report-code";
		final String SD_OJK_REPORT_SETUP_DIRECT_DROPDOWN_ROW = SD_OJK_REPORT_SETUP_DIRECT + "/dropdown-row";
		final String SD_OJK_REPORT_SETUP_DIRECT_DROPDOWN_COA = SD_OJK_REPORT_SETUP_DIRECT + "/dropdown-coa";
		...
		//Direct Production BDS
		final String M_DPRODUCTION_BDS			= "/direct-production_bds";
		final String M_DPRODUCTION_BDS_CLOSING_SEARCH			= M_DPRODUCTION_BDS + "/closing-search";
		final String M_DPRODUCTION_BDS_DELETE					= M_DPRODUCTION_BDS + "/delete";
		final String M_DPRODUCTION_BDS_DROPDOWN_DOCUMENT_TYPE	= M_DPRODUCTION_BDS + "/dropdown-document-type";
		final String M_DPRODUCTION_BDS_DROPDOWN_TC_GROUP		= M_DPRODUCTION_BDS + "/dropdown-tc-group";
		final String M_DPRODUCTION_BDS_DROPDOWN_TC_DETAILS		= M_DPRODUCTION_BDS + "/dropdown-tc-details";
		final String M_DPRODUCTION_BDS_DROPDOWN_NAME			= M_DPRODUCTION_BDS + "/get-dropdownName";
		final String M_DPRODUCTION_BDS_DROPDOWN_TYPE_OF_COVER	= M_DPRODUCTION_BDS + "/get-dropdownTypeOfCover";
		final String M_DPRODUCTION_BDS_GET_WHT_CLIENT			= M_DPRODUCTION_BDS + "/get-whtClient";
		final String M_DPRODUCTION_BDS_COMM_OUT_NAME			= M_DPRODUCTION_BDS + "/dropdown-commOutName";
		final String M_DPRODUCTION_BDS_GET_CLIENT				= M_DPRODUCTION_BDS + "/get-client";
		final String M_DPRODUCTION_BDS_INQ						= M_DPRODUCTION_BDS + "/inquiry";
		final String M_DPRODUCTION_BDS_INQ_MODIFY				= M_DPRODUCTION_BDS + "/inquiryModify";
		final String M_DPRODUCTION_BDS_INQ_SEND					= M_DPRODUCTION_BDS + "/inquirySend";
		final String M_DPRODUCTION_BDS_UPLOAD_FILE				= M_DPRODUCTION_BDS + "/upload-file";
		final String M_DPRODUCTION_BDS_SEARCH					= M_DPRODUCTION_BDS + "/search";
		final String M_DPRODUCTION_BDS_PRINT					= M_DPRODUCTION_BDS + "/print";
		final String M_DPRODUCTION_BDS_DOCUMENT					= M_DPRODUCTION_BDS + "/document";
		final String M_DPRODUCTION_BDS_SEND_EMAIL				= M_DPRODUCTION_BDS + "/send-email";
		final String M_DPRODUCTION_BDS_CLOSING					= M_DPRODUCTION_BDS + "/closing";
		final String M_DPRODUCTION_BDS_MA_0011					= M_DPRODUCTION_BDS + "/ma-0011";
		final String M_DPRODUCTION_BDS_MA_0012					= M_DPRODUCTION_BDS + "/ma-0012";
		final String M_DPRODUCTION_BDS_SAVE						= M_DPRODUCTION_BDS + "/save";
		final String M_DPRODUCTION_BDS_TERM_AND_CONDITION		= M_DPRODUCTION_BDS + "/term-and-condition";
		final String M_DPRODUCTION_BDS_IS_VALID_TRX_DATE		= M_DPRODUCTION_BDS + "/isValidTrxDate";
		final String M_DPRODUCTION_BDS_VALIDATION_USER_LEVEL	= M_DPRODUCTION_BDS + "/validationUserLevel";
		final String M_DPRODUCTION_BDS_DOWNLOAD_FILE			= M_DPRODUCTION_BDS + "/download-file";
	...
	interface URI {
		...
		// Setup OJK Report
		final String SD_OJK_REPORT_SETUP_INQUIRY				= "/app-re-broker/static-data/ojk-report-setup-direct/inquiry";
		final String SD_OJK_REPORT_SETUP_DELETE					= "/app-re-broker/static-data/ojk-report-setup-direct/delete";
		final String SD_OJK_REPORT_SETUP_SAVE					= "/app-re-broker/static-data/ojk-report-setup-direct/save";
		final String SD_OJK_REPORT_SETUP_GET_REPORT_CODE		= "/app-re-broker/static-data/ojk-report-setup-direct/dropdown-report-code";
		final String SD_OJK_REPORT_SETUP_GET_ROW				= "/app-re-broker/static-data/ojk-report-setup-direct/dropdown-row";
		final String SD_OJK_REPORT_SETUP_GET_COA				= "/app-re-broker/static-data/ojk-report-setup-direct/dropdown-coa";
		...
		//Production Direct BDS
		final String M_DPRODUCTION_BDS_GET_COMM_OUT_NAME	= "/app-re-broker/marketing/direct-production_bds/get-commOutName";
		final String M_DPRODUCTION_BDS_GET_WHT_CLIENT		= "/app-re-broker/marketing/direct-production_bds/get-whtClient";
		final String M_DPRODUCTION_BDS_SAVE					= "/app-re-broker/marketing/direct-production_bds/save";
		final String M_DPRODUCTION_BDS_INQ_MODIFY			= "/app-re-broker/marketing/direct-production_bds/inquiryModify";
		final String M_DPRODUCTION_BDS_INQ_SEND				= "/app-re-broker/marketing/direct-production_bds/inquirySend";
		final String M_DPRODUCTION_BDS_RPT_HMTL				= "/app-re-broker/marketing/direct-production_bds/report/create-html";
		final String M_DPRODUCTION_BDS_RPT_DOC				= "/app-re-broker/marketing/direct-production_bds/report/create-doc";
		final String M_DPRODUCTION_BDS_RPT_PDF				= "/app-re-broker/marketing/direct-production_bds/report/create-pdf";
		final String M_DPRODUCTION_BDS_SEND_EMAIL			= "/app-re-broker/marketing/direct-production_bds/send-email";
		final String M_DPRODUCTION_BDS_CLOSING				= "/app-re-broker/marketing/direct-production_bds/closing";
		final String M_DPRODUCTION_BDS_RPT_CLOSING_HTML		= "/app-re-broker/marketing/direct-production_bds/create-closing-html";
