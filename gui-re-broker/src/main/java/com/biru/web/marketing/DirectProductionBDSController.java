...
public class DirectProductionBDSController {
    ...
    public @ResponseBody String inquiryModify(@RequestBody HashMap<String, Object> param) throws JsonProcessingException {
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_INQ_MODIFY + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    public @ResponseBody String save(@RequestBody HashMap<String, Object> param) throws JsonProcessingException {
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_SAVE + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    @RequestMapping(value = REST.M_DPRODUCTION_BDS_MA_0012, method = RequestMethod.GET)
    ...
    public @ResponseBody String dropdownCommOutName(
        ...
        String uri = host + URI.M_DPRODUCTION_BDS_GET_COMM_OUT_NAME + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    public @ResponseBody String getWhtClient(@RequestParam(name = "cliCode") String cliCode) {
        ...
        String uri = host + URI.M_DPRODUCTION_BDS_GET_WHT_CLIENT + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    @RequestMapping(value = REST.M_DPRODUCTION_BDS_DOWNLOAD_FILE + "/{fileName}", method = RequestMethod.GET)
    ...
    public @ResponseBody String search(
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_RPT_HMTL + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    public @ResponseBody String inquirySend(@RequestBody Map<String, Object> param) throws IOException {
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_INQ_SEND + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    public void print(HttpServletResponse httpResponse,
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_RPT_PDF + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    public @ResponseBody byte[] exportDoc(HttpServletResponse httpResponse,
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_RPT_DOC + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    public @ResponseBody String sendEmail(@RequestBody Map<String, Object> param) throws IOException {
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_SEND_EMAIL + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    public @ResponseBody String closing(@RequestBody Map<String, Object> param) throws IOException {
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_CLOSING + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
    ...
    public @ResponseBody String closingSearch(
        ...
        String uri = sessionComponent.getHost() + URI.M_DPRODUCTION_BDS_RPT_CLOSING_HTML + "?tenantId=" + sessionComponent.getTenantId();
        ResponseEntity<String> response = restTemplate.exchange(uri, HttpMethod.POST, httpEntity, String.class);
