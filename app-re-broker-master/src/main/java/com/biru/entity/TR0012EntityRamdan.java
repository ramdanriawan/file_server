...
@Entity
@Table(name = "TR0012")
@NamedQuery(name = "TR0012EntityRamdan.findAll", query = "SELECT t FROM TR0012EntityRamdan t")
public class TR0012EntityRamdan implements Serializable, Comparable<TR0012EntityRamdan> {
    ...
    @Column(name = "CLI_NAME", insertable = false, updatable = false, nullable = true)
    private String cliName;

    @Column(name = "overdue", insertable = false, updatable = false, nullable = true)
    private String overdue;

    @Column(name = "invoice", insertable = false, updatable = false, nullable = true)
    private String invoice;

    @Column(name = "settlement", insertable = false, updatable = false, nullable = true)
    private String settlement;

    @Column(name = "outstanding", insertable = false, updatable = false, nullable = true)
    private String outstanding;

    @Column(name = "SA_NAME", insertable = false, updatable = false, nullable = true)
    private String officer;

    @Column(name = "set_amount", insertable = false, updatable = false, nullable = true)
    private String setAmount;

    public String getSetAmount() {

        if (this.trxType.equalsIgnoreCase("SE")) {
            this.setAmount = "0";
        }
    ...
    public TR0012EntityRamdan(Long idKey, String trxDateStr, String trxType, String trxVoucherId, String cliName, String trxDescription,
    ...
    public TR0012EntityRamdan(Long idKey, String trxType, String trxVoucherId,
    ...
    public TR0012EntityRamdan(Long idKey, Date createOn, Date trxDate,
    ...
    @Override
    public int compareTo(TR0012EntityRamdan tR0012Entity) {
